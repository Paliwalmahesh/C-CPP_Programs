...
int main()
{
    ...
    while (1)
    {
        ...
        if(currentstate==menu)
        {
			...
			printf("\n\t\t\t\t--------------------------------------------\n");
			printf("\n\t\t\t\tPLEASE LOGIN OR SIGNUP FOR FURTHUR PROCESSS \n");
            printf("\n\t\t\t\t1)SIGN UP\n\t\t\t\t2)Login User \n\t\t\t\t3)Exit\n\n\t\t\t\tEnter:");
            scanf("%d",&ch1);
            switch(ch1)
            {
		...
		printf("\n\t\t\t\tTOURISM MANAGEMENT SYSTEM");
		printf("\n\t\t\t\t-------------------------\n");
		printf("\n\t\t\t\tWELCOME TO OUR SYSTEM PLEASE SELECT \n");	
            printf("\n\t\t\t\t1)Book Package \n\t\t\t\t2)Check Ticket\n\t\t\t\t3)Cancel Ticket\n\t\t\t\t4)Change Password"
                   "\n\t\t\t\t5)Logout User \n\t\t\t\t6)Brochure \n\t\t\t\t7)Exit\n");
            scanf("%d",&ch2);
            switch(ch2)
...
{
	system("CLS");
    printf("\tPRICE LIST\n=============================\n1. LL - California- Rs 40000\n2. JK - Jammu and Kashmir - Rs 60000\n3. SK - Seven Sisters(Assam) - Rs 25000\n4. SHM - Himachal Pradesh - Rs 38000\n"
           "5. AND - Andaman and Nicobar - Rs 120000\n6. BHB - Bombay - Rs 10000\n7. AG - Goa - Rs 30000\n8. ND - New Delhi - Rs 32000\n9. RJ - Rajasthan - Rs 45000\n10. SI - South India - Rs 250000\n");
}
...
void CheckTicket(user *h)
{
    ...
    printf("\n\t\t\t\t YOUR TICKET BOOKINGS ");
    printf("\n\t\t\t\t ---------------------- ");
    printf("\n\t\t\t\t FROM TRAVEL MANGEMENT ");
    printf("\n\t\t\t\t ---------------------- ");
    printf("\n\t\t\t\t tour code %s            Total ammount for tickets:Rs %f ",h->place,total);
    printf("\n\n\t\t\t\t Number of tickets booked: %d ",h->numtick);
